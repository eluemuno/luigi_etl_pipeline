            ...
            if source_name == 'avro':
                ...
                for file in source_path:
                    ...
                    for avro_record in parsed_avro_file:
                        ...
                        output_file = pd.DataFrame(avro_data).to_csv(path_out +'emeka.csv', mode='a', header=False, index=False,
                                                                     sep=',', line_terminator='\n')
                ...
                for file in source_path:
                    ...
                    for csv_record in parsed_csv_file:
                        ...
                        output_file = pd.DataFrame(csv_data).to_csv(path_out + 'emeka.csv', mode='a', header=False, index=False,
                                                                    sep=',', line_terminator='\n')
                ...
                for file in source_path:
                    with open(file, 'rb') as orc_file:
                        ...
                        output_file = df.to_csv(path_out + 'emeka.csv', mode='a', header=False,
                ...
                for file in source_path:
                    ...
                    output_file = df.to_csv(path_out + 'emeka.csv', mode='a', header=False, index=False,
                                                                    sep=',', line_terminator='\n')
